...
const AppSpecifications = () => {
  ...
  const architectureData = {
    frontend: {
      title: 'フロントエンド',
      items: [
        { name: 'React Native', version: '0.74+', description: 'クロスプラットフォーム開発フレームワーク' },
        { name: 'Expo Router', version: 'v3', description: 'ファイルベースルーティングシステム' },
        { name: 'TypeScript', version: '5.0+', description: '型安全性を提供する静的型付けJavaScript' },
        { name: 'React Native Web', version: 'latest', description: 'Web対応のクロスプラットフォーム機能' },
      ]
    },
    backend: {
      title: 'バックエンド・データベース',
      items: [
        { name: 'Firebase Firestore', version: 'v10', description: 'リアルタイムNoSQLデータベース' },
        { name: 'Firebase Auth', version: 'v10', description: '認証・ユーザー管理システム' },
        { name: 'Firebase Storage', version: 'v10', description: 'ファイル・画像ストレージサービス' },
        { name: 'Firebase Functions', version: 'v4', description: 'サーバーレス関数実行環境' },
      ]
    },
    tools: {
      title: '開発ツール・ライブラリ',
      items: [
        { name: 'React Native Vector Icons', version: 'latest', description: 'アイコンライブラリ' },
        { name: 'React Hook Form', version: 'v7', description: 'フォーム管理ライブラリ' },
        { name: 'Crypto-JS', version: 'v4', description: 'AES-256暗号化ライブラリ' },
        { name: 'date-fns', version: 'v2', description: '日付操作ユーティリティ' },
      ]
    }
  };
  ...
  const featuresData = [
    {
      ...
      specifications: [
        ...
        'ステータス管理: 7段階のシフトステータス (下書き→申請中→承認済み→完了)',
