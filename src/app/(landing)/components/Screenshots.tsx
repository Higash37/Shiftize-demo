...
const Screenshots = () => {
  ...
  const screenshots = {
    gantt: {
      ...
      features: ["ドラッグ&ドロップ操作", "リアルタイム更新", "色分け表示", "一括操作"]
    },
    mobile: {
      title: "モバイル対応",
      description: "スマホからでも快適にシフト管理",
      image: "/api/placeholder/800/500",
      features: ["レスポンシブデザイン", "タッチ操作最適化", "プッシュ通知", "オフライン対応"]
    },
    dashboard: {
      title: "分析ダッシュボード",
      description: "人件費やシフト充足率を可視化",
      image: "/api/placeholder/800/500",
      features: ["リアルタイム分析", "コスト可視化", "トレンド表示", "レポート出力"]
    },
    staff: {
      title: "スタッフ画面",
            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 aspect-video flex items-center justify-center">
                <div className="text-center">
                  <div className="text-6xl mb-4">{viewOptions.find(v => v.key === activeView)?.icon}</div>
                  <div className="text-gray-500 text-lg">
                    {screenshots[activeView].title}のスクリーンショット
                  </div>
              ...
              <div className="absolute top-0 left-0 right-0 h-8 bg-gray-800 rounded-t-2xl flex items-center px-4">
                ...
                <div className="flex-1 text-center">
                  <div className="text-white text-xs">shift-scheduler-app.com</div>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold mb-4 gradient-text">
                    {screenshots[activeView].title}
                  </h3>
                  <p className="text-gray-600 text-lg mb-6">
                    {screenshots[activeView].description}
                  </p>
                  
                  {/* Feature List */}
                  <div className="grid grid-cols-2 gap-3">
                    {screenshots[activeView].features.map((feature, index) => (
                ...
                <div className="space-y-6">
                  <div className="card p-6 bg-gradient-to-r from-blue-50 to-indigo-50">
                    <div className="text-2xl font-bold gradient-text mb-2">71,464行</div>
                    <div className="text-gray-600 text-sm">のコードで構築された堅牢なシステム</div>
                  </div>
                  <div className="card p-6 bg-gradient-to-r from-green-50 to-emerald-50">
                    <div className="text-2xl font-bold text-green-600 mb-2">5+店舗</div>
                    <div className="text-gray-600 text-sm">で実際に運用中</div>
                  </div>
                  <div className="card p-6 bg-gradient-to-r from-purple-50 to-pink-50">
                    <div className="text-2xl font-bold text-purple-600 mb-2">100%</div>
                    <div className="text-gray-600 text-sm">モバイル対応済み</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-600 font-medium">React Native</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-600 font-medium">PWA</span>
            </div>
          </div>
        </div>
