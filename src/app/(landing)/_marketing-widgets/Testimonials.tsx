  ...
  const testimonials = [
    {
      ...
      avatar: "A",
      content:
        "導入前は毎週3時間かけてExcelでシフトを作っていましたが、今では30分で完了。急な講師の欠勤にも、募集機能で素早く対応できるようになりました。",
      stats: "月10時間削減",
      period: "導入1ヶ月",
    },
    {
      ...
      avatar: "B",
      content:
        "スタッフからの「シフトがわからない」という問い合わせが0になりました。みんなスマホで確認できるので、連絡の手間が劇的に減りました。",
      stats: "問い合わせ100%削減",
      period: "導入予定",
    },
    {
      ...
      avatar: "C",
      content:
        "以前は紙でシフト希望を出していて、結果もよくわからない状態でした。今はスマホで申請して、承認状況もすぐ確認できて安心です。",
      stats: "満足度大幅向上",
      period: "利用1ヶ月",
    },
  ];
