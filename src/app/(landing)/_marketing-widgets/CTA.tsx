  ...
  return (
    <section className="section-padding bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-32 right-10 w-24 h-24 bg-white rounded-full animate-bounce" style={{animationDelay: '1.5s'}}></div>
      </div>
      ...
      <div className="container-responsive relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed">
            月間10時間の削減効果を
            <span className="font-bold text-yellow-300">無料</span>で体験してみませんか？
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-yellow-300">80%</div>
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-yellow-300">0</div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-8">
            ...
            <p className="text-blue-100">
              今なら初月無料 + セットアップサポート付き<br />
              <span className="text-sm opacity-75">※ ベーシックプラン以上が対象</span>
            </p>
          </div>
