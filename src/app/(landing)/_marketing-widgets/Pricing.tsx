  ...
  const faq = [
    {
      ...
      answer:
        "無料プランは5名までの小規模利用に限定されており、外部連携やレポート機能に制限があります。有料プランでは人数制限の拡大と全機能をご利用いただけます。",
    },
    {
      question: "支払い方法は何が利用できますか？",
      answer:
        "クレジットカード（Visa、MasterCard、JCB、American Express）、銀行振込に対応しています。年間プランをお選びいただくと20%の割引が適用されます。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Excelからのデータインポート機能があり、CSVファイルから簡単にシフトデータを移行できます。また、初期設定のサポートも承っております。",
    },
  ];
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center space-x-4">
            ...
            <button
              ...
              aria-label={
                isYearly ? "月額払いに切り替える" : "年額払いに切り替える"
              }
              title={isYearly ? "月額払いに切り替える" : "年額払いに切り替える"}
            >
              <span
