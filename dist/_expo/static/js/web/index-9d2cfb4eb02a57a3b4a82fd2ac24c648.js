__d(function(g,r,i,a,m,e,d){Object.defineProperty(e,"__esModule",{value:!0}),Object.keys(r(d[0])).forEach(function(n){"default"!==n&&"__esModule"!==n&&(n in e&&e[n]===r(d[0])[n]||Object.defineProperty(e,n,{enumerable:!0,get:function(){return r(d[0])[n]}}))})},2336,[2341]);
__d(function(g,r,_i,a,m,e,d){Object.defineProperty(e,"__esModule",{value:!0}),e.getPerformance=function getPerformance(t=(0,r(d[4]).getApp)()){t=(0,r(d[1]).getModularInstance)(t);const n=(0,r(d[4])._getProvider)(t,"performance");return n.getImmediate()},e.initializePerformance=function initializePerformance(t,n){t=(0,r(d[1]).getModularInstance)(t);const i=(0,r(d[4])._getProvider)(t,"performance");if(i.isInitialized()){const t=i.getImmediate(),o=i.getOptions();if((0,r(d[1]).deepEqual)(o,null!=n?n:{}))return t;throw T.create("already initialized")}return i.initialize({options:n})},e.trace=function trace(t,n){return t=(0,r(d[1]).getModularInstance)(t),new Trace(t,n)},r(d[0]);const t="@firebase/performance",n="0.7.7",i=n,o="FB-PERF-TRACE-MEASURE",s="_wt_",c="_fcp",l="_fid",u="_lcp",p="_inp",f="_cls",h="@firebase/performance/config",v="@firebase/performance/configexpire",b="Performance",_={"trace started":"Trace {$traceName} was started before.","trace stopped":"Trace {$traceName} is not running.","nonpositive trace startTime":"Trace {$traceName} startTime should be positive.","nonpositive trace duration":"Trace {$traceName} duration should be positive.","no window":"Window is not available.","no app id":"App id is not available.","no project id":"Project id is not available.","no api key":"Api key is not available.","invalid cc log":"Attempted to queue invalid cc event","FB not default":"Performance can only start when Firebase app instance is the default one.","RC response not ok":"RC response is not ok","invalid attribute name":"Attribute name {$attributeName} is invalid.","invalid attribute value":"Attribute value {$attributeValue} is invalid.","invalid custom metric name":"Custom metric name {$customMetricName} is invalid","invalid String merger input":"Input for String merger is invalid, contact support team to resolve.","already initialized":"initializePerformance() has already been called with different options. To avoid this error, call initializePerformance() with the same options as when it was originally called, or call getPerformance() to return the already initialized instance."},T=new(r(d[1]).ErrorFactory)("performance",b,_),S=new(r(d[2]).Logger)(b);
/**
   * @license
...
/**
   ...
   * limitations under the License.
   */
function mergeStrings(t,n){const i=t.length-n.length;if(i<0||i>1)throw T.create("invalid String merger input");const o=[];for(let i=0;i<t.length;i++)o.push(t.charAt(i)),n.length>i&&o.push(n.charAt(i));return o.join("")}
/**
   * @license
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */var y;!function(t){t[t.UNKNOWN=0]="UNKNOWN",t[t.VISIBLE=1]="VISIBLE",t[t.HIDDEN=2]="HIDDEN"}(y||(y={}));const M=["firebase_","google_","ga_"],k=new RegExp("^[a-zA-Z]\\w*$");function getServiceWorkerStatus(){const t=Api.getInstance().navigator;return(null==t?void 0:t.serviceWorker)?t.serviceWorker.controller?2:3:1}function getVisibilityState(){switch(Api.getInstance().document.visibilityState){case"visible":return y.VISIBLE;case"hidden":return y.HIDDEN;default:return y.UNKNOWN}}function getEffectiveConnectionType(){const t=Api.getInstance().navigator.connection;switch(t&&t.effectiveType){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
function getAppId(t){var n;const i=null===(n=t.options)||void 0===n?void 0:n.appId;if(!i)throw T.create("no app id");return i}
/**
   * @license
   * Copyright 2020 Google LLC
   *
   ...
   * limitations under the License.
   */
const N="0.0.1",P={loggingEnabled:!0},C="FIREBASE_INSTALLATIONS_AUTH";function getConfig(t,n){const o=function getStoredConfig(){const t=Api.getInstance().localStorage;if(!t)return;const n=t.getItem(v);if(!n||!function configValid(t){return Number(t)>Date.now()}(n))return;const i=t.getItem(h);if(!i)return;try{return JSON.parse(i)}catch(t){return}}();return o?(processConfig(o),Promise.resolve()):function getRemoteConfig(t,n){return function getAuthTokenPromise(t){const n=t.getToken();return n.then(t=>{}),n}(t.installations).then(o=>{const s=function getProjectId(t){var n;const i=null===(n=t.options)||void 0===n?void 0:n.projectId;if(!i)throw T.create("no project id");return i}(t.app),c=function getApiKey(t){var n;const i=null===(n=t.options)||void 0===n?void 0:n.apiKey;if(!i)throw T.create("no api key");return i}(t.app),l=new Request(`https://firebaseremoteconfig.googleapis.com/v1/projects/${s}/namespaces/fireperf:fetch?key=${c}`,{method:"POST",headers:{Authorization:`${C} ${o}`},body:JSON.stringify({app_instance_id:n,app_instance_id_token:o,app_id:getAppId(t.app),app_version:i,sdk_version:N})});return fetch(l).then(t=>{if(t.ok)return t.json();throw T.create("RC response not ok")})}).catch(()=>{S.info(R)})}(t,n).then(processConfig).then(t=>function storeConfig(t){const n=Api.getInstance().localStorage;if(!t||!n)return;n.setItem(h,JSON.stringify(t)),n.setItem(v,String(Date.now()+60*SettingsService.getInstance().configTimeToLive*60*1e3))}(t),()=>{})}const R="Could not fetch config, will use default configs";function processConfig(t){if(!t)return t;const n=SettingsService.getInstance(),i=t.entries||{};return void 0!==i.fpr_enabled?n.loggingEnabled="true"===String(i.fpr_enabled):n.loggingEnabled=P.loggingEnabled,i.fpr_log_source?n.logSource=Number(i.fpr_log_source):P.logSource&&(n.logSource=P.logSource),i.fpr_log_endpoint_url?n.logEndPointUrl=i.fpr_log_endpoint_url:P.logEndPointUrl&&(n.logEndPointUrl=P.logEndPointUrl),i.fpr_log_transport_key?n.transportKey=i.fpr_log_transport_key:P.transportKey&&(n.transportKey=P.transportKey),void 0!==i.fpr_vc_network_request_sampling_rate?n.networkRequestsSamplingRate=Number(i.fpr_vc_network_request_sampling_rate):void 0!==P.networkRequestsSamplingRate&&(n.networkRequestsSamplingRate=P.networkRequestsSamplingRate),void 0!==i.fpr_vc_trace_sampling_rate?n.tracesSamplingRate=Number(i.fpr_vc_trace_sampling_rate):void 0!==P.tracesSamplingRate&&(n.tracesSamplingRate=P.tracesSamplingRate),n.logTraceAfterSampling=shouldLogAfterSampling(n.tracesSamplingRate),n.logNetworkAfterSampling=shouldLogAfterSampling(n.networkRequestsSamplingRate),t}function shouldLogAfterSampling(t){return Math.random()<=t}
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */let L,B=3,z=[],F=!1;function processQueue(t){setTimeout(()=>{B<=0||(z.length>0&&dispatchQueueEvents(),processQueue(1e4))},t)}function dispatchQueueEvents(){const t=z.splice(0,1e3),n=t.map(t=>({source_extension_json_proto3:t.message,event_time_ms:String(t.eventTime)}));(function postToFlEndpoint(t){const n=SettingsService.getInstance().getFlTransportFullUrl(),i=JSON.stringify(t);return navigator.sendBeacon&&navigator.sendBeacon(n,i)?Promise.resolve():fetch(n,{method:"POST",body:i,keepalive:!0}).then()})({request_time_ms:String(Date.now()),client_info:{client_type:1,js_client_info:{}},log_source:SettingsService.getInstance().logSource,log_event:n}).then(()=>{B=3}).catch(()=>{z=[...t,...z],B--,S.info(`Tries left: ${B}.`),processQueue(1e4)})}function transportHandler(t){return(...n)=>{!function addToQueue(t){if(!t.eventTime||!t.message)throw T.create("invalid cc log");z=[...z,t]}({message:t(...n),eventTime:Date.now()})}}function flushQueuedEvents(){for(;z.length>0;)dispatchQueueEvents()}
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */let D,$={},V=!1;function setupOobResources(t){getIid()&&(setTimeout(()=>function setupOobTraces(t){const n=Api.getInstance();"onpagehide"in window?n.document.addEventListener("pagehide",()=>sendOobTrace(t)):n.document.addEventListener("unload",()=>sendOobTrace(t));n.document.addEventListener("visibilitychange",()=>{"hidden"===n.document.visibilityState&&sendOobTrace(t)}),n.onFirstInputDelay&&n.onFirstInputDelay(t=>{D=t});n.onLCP(t=>{var n;$.lcp={value:t.value,elementAttribution:null===(n=t.attribution)||void 0===n?void 0:n.element}}),n.onCLS(t=>{var n;$.cls={value:t.value,elementAttribution:null===(n=t.attribution)||void 0===n?void 0:n.largestShiftTarget}}),n.onINP(t=>{var n;$.inp={value:t.value,elementAttribution:null===(n=t.attribution)||void 0===n?void 0:n.interactionTarget}})}(t),0),setTimeout(()=>function setupNetworkRequests(t){const n=Api.getInstance(),i=n.getEntriesByType("resource");for(const n of i)createNetworkRequestEntry(t,n);n.setupObserver("resource",n=>createNetworkRequestEntry(t,n))}(t),0),setTimeout(()=>function setupUserTimingTraces(t){const n=Api.getInstance(),i=n.getEntriesByType("measure");for(const n of i)createUserTimingTrace(t,n);n.setupObserver("measure",n=>createUserTimingTrace(t,n))}(t),0))}function createUserTimingTrace(t,n){const i=n.name;i.substring(0,21)!==o&&Trace.createUserTimingTrace(t,i)}function sendOobTrace(t){if(!V){V=!0;const n=Api.getInstance(),i=n.getEntriesByType("navigation"),o=n.getEntriesByType("paint");setTimeout(()=>{Trace.createOobTrace(t,i,o,$,D)},0)}}
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */(window);const s=new PerformanceController(i,o);return s._init(n),s};!function registerPerformance(){(0,r(d[4])._registerComponent)(new(r(d[5]).Component)("performance",factory,"PUBLIC")),(0,r(d[4]).registerVersion)(t,n),(0,r(d[4]).registerVersion)(t,n,"esm2017")}()},2341,[2334,617,620,2342,619,621]);
__d(function(g,r,i,a,m,e,d){Object.defineProperty(e,"__esModule",{value:!0}),Object.keys(r(d[0])).forEach(function(n){"default"!==n&&"__esModule"!==n&&(n in e&&e[n]===r(d[0])[n]||Object.defineProperty(e,n,{enumerable:!0,get:function(){return r(d[0])[n]}}))})},2342,[2343]);
