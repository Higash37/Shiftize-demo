...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const v="installations",publicFactory=t=>{const e=t.getProvider("app").getImmediate(),n=function extractAppConfig(t){if(!t||!t.options)throw getMissingValueError("App Configuration");if(!t.name)throw getMissingValueError("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw getMissingValueError(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}(e);return{app:e,appConfig:n,heartbeatServiceProvider:(0,r(d[2])._getProvider)(e,"heartbeat"),_delete:()=>Promise.resolve()}},internalFactory=t=>{const e=t.getProvider("app").getImmediate(),n=(0,r(d[2])._getProvider)(e,v).getImmediate();return{getId:()=>getId(n),getToken:t=>getToken(n,t)}};!function registerInstallations(){(0,r(d[2])._registerComponent)(new(r(d[3]).Component)(v,publicFactory,"PUBLIC")),(0,r(d[2])._registerComponent)(new(r(d[3]).Component)("installations-internal",internalFactory,"PRIVATE"))}(),(0,r(d[2]).registerVersion)(t,e),(0,r(d[2]).registerVersion)(t,e,"esm2020")},2373,[669,673,671,672]);
__d(function(g,_r,_i,a,m,_e,d){var e=_r(d[0]);Object.defineProperty(_e,"__esModule",{value:!0}),_e.TimeInput=void 0;var t=e(_r(d[1])),n=function _interopRequireWildcard(e,t){if("function"==typeof WeakMap)var n=new WeakMap,r=new WeakMap;return function(e,t){if(!t&&e&&e.__esModule)return e;var l,u,i={__proto__:null,default:e};if(null===e||"object"!=typeof e&&"function"!=typeof e)return i;if(l=t?r:n){if(l.has(e))return l.get(e);l.set(e,i)}for(const t in e)"default"!==t&&{}.hasOwnProperty.call(e,t)&&((u=(l=Object.defineProperty)&&Object.getOwnPropertyDescriptor(e,t))&&(u.get||u.set)?l(i,t,u):i[t]=e[t]);return i}(e,t)}(_r(d[2])),r=e(_r(d[3])),l=_r(d[4]);const u=["value","onChangeText","placeholder","isError","style"];_e.TimeInput=e=>{let{value:i,onChangeText:o,placeholder:s="00:00",isError:c=!1,style:f}=e,p=(0,t.default)(e,u);const[h,b]=(0,n.useState)(i);(0,n.useEffect)(()=>{i!==h&&b(i)},[i]);const formatTime=e=>{const t=e.replace(/\D/g,"");if(""===t)return"";if(1===t.length){return Number.parseInt(t,10)>=3?"0"+t+":":t}if(2===t.length){return Number.parseInt(t,10)>23?"23:":t+":"}if(3===t.length){const e=t.substring(0,2),n=t.substring(2,3);return Number.parseInt(e,10)>23?"23:"+n:e+":"+n}if(t.length>=4){let e=t.substring(0,2),n=t.substring(2,4);return Number.parseInt(e,10)>23&&(e="23"),Number.parseInt(n,10)>59&&(n="59"),e+":"+n}return t};return(0,l.jsx)(r.default,Object.assign({},p,{value:h,onChangeText:e=>{if(e.length<h.length){if(h.endsWith(":")&&e===h.slice(0,-1))return void b(e);const t=e.replace(/\D/g,"");return void(""===t?(b(""),o("")):b(t))}if(e.length>h.length){const t=formatTime(e);return b(t),void(5===t.length&&t.includes(":")?o(t):""===t&&o(""))}const t=formatTime(e);b(t),5===t.length&&t.includes(":")?o(t):""===t&&o("")},onBlur:()=>{if(h&&h.length>0&&h.length<5){let e=h;if(e.includes(":")){const t=e.split(":");e=(e=>1===e[1]?.length?e[0]+":"+e[1]+"0":void 0===e[1]||""===e[1]?e[0]+":00":e.join(":"))(t)}else e=(e=>1===e.length?"0"+e+":00":2===e.length?e+":00":e)(e);5===e.length&&(e=(e=>{const t=e.split(":");if("00"===t[0]||"01"===t[0]||"02"===t[0])return Number.parseInt(t[0],10).toString()+":"+t[1];return e})(e)),b(e),o(e)}},placeholder:s,keyboardType:"number-pad",maxLength:5,style:[f,c&&{borderColor:"#FF4444",borderWidth:1}]}))}},2377,[12,47,8,296,6]);